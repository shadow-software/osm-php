...
/**
 * ClusterConfiguration Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class ClusterConfiguration implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClusterConfiguration';
...
'routing' => '\Swagger\Client\Model\ClusterConfigurationRouting',
'clustering' => '\Swagger\Client\Model\ClusterConfigurationClustering'    ];
...
'clustering' => 'getClustering'    ];
    ...
    {
        $this->container['response_type'] = isset($data['response_type']) ? $data['response_type'] : 'json';
     ...
     * Sets response_type
     *
     * @param string $response_type Specifies the response format. You can either choose `geojson` or `json`.
     *
     * @return $this
     */
     ...
     * Gets routing
     *
     * @return \Swagger\Client\Model\ClusterConfigurationRouting
     */
     ...
     * Sets routing
     *
     * @param \Swagger\Client\Model\ClusterConfigurationRouting $routing routing
     *
     * @return $this
     */
     ...
     * Gets clustering
     *
     * @return \Swagger\Client\Model\ClusterConfigurationClustering
     */
     ...
     * Sets clustering
     *
     * @param \Swagger\Client\Model\ClusterConfigurationClustering $clustering clustering
     *
     * @return $this
     */
