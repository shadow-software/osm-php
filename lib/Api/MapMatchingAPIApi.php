...
/**
 * MapMatchingAPIApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class MapMatchingAPIApi
{
     ...
     *
     * @param  int $gps_accuracy Specify the precision of a point, in meter (optional)
     * @param  string $vehicle Specify the vehicle profile like car (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\RouteResponse
     */
    public function postGPX($gps_accuracy = null, $vehicle = null)
    {
        list($response) = $this->postGPXWithHttpInfo($gps_accuracy, $vehicle);
        return $response;
    }
     ...
     */
    public function postGPXWithHttpInfo($gps_accuracy = null, $vehicle = null)
    {
        $returnType = '\Swagger\Client\Model\RouteResponse';
        $request = $this->postGPXRequest($gps_accuracy, $vehicle);
     ...
     */
    public function postGPXAsync($gps_accuracy = null, $vehicle = null)
    {
        return $this->postGPXAsyncWithHttpInfo($gps_accuracy, $vehicle)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postGPXAsyncWithHttpInfo($gps_accuracy = null, $vehicle = null)
    {
        $returnType = '\Swagger\Client\Model\RouteResponse';
        $request = $this->postGPXRequest($gps_accuracy, $vehicle);
     ...
     */
    protected function postGPXRequest($gps_accuracy = null, $vehicle = null)
    {
        ...
        // query params
        if ($gps_accuracy !== null) {
            $queryParams['gps_accuracy'] = ObjectSerializer::toQueryValue($gps_accuracy, null);
        }
        // query params
        if ($vehicle !== null) {
