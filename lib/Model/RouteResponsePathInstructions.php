...
'turn_angle' => 'getTurnAngle'    ];
     ...
     * Sets exit_number
     *
     * @param int $exit_number Only available for roundabout instructions (sign is 6). The count of exits at which the route leaves the roundabout.
     *
     * @return $this
     */
     ...
     * Sets turn_angle
     *
     * @param double $turn_angle Only available for roundabout instructions (sign is 6). The radian of the route within the roundabout `0 < r < 2*PI` for clockwise and `-2*PI < r < 0` for counterclockwise turns.
     *
     * @return $this
     */
