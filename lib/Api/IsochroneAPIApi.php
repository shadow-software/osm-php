...
/**
 * IsochroneAPIApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class IsochroneAPIApi
{
     ...
     * @param  int $buckets Number by which to divide the given &#x60;time_limit&#x60; to create &#x60;buckets&#x60; nested isochrones of time intervals &#x60;time_limit-n*time_limit/buckets&#x60;. Applies analogously to &#x60;distance_limit&#x60;. (optional, default to 1)
     ...
     * @param  string $weighting Use &#x60;\&quot;shortest\&quot;&#x60; to get an isodistance line instead of an isochrone. (optional, default to fastest)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\IsochroneResponse
     */
    public function getIsochrone($point, $time_limit = '600', $distance_limit = null, $vehicle = null, $buckets = '1', $reverse_flow = 'false', $weighting = 'fastest')
    {
     ...
     */
    public function getIsochroneWithHttpInfo($point, $time_limit = '600', $distance_limit = null, $vehicle = null, $buckets = '1', $reverse_flow = 'false', $weighting = 'fastest')
    {
     ...
     */
    public function getIsochroneAsync($point, $time_limit = '600', $distance_limit = null, $vehicle = null, $buckets = '1', $reverse_flow = 'false', $weighting = 'fastest')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIsochroneAsyncWithHttpInfo($point, $time_limit = '600', $distance_limit = null, $vehicle = null, $buckets = '1', $reverse_flow = 'false', $weighting = 'fastest')
    {
        $returnType = '\Swagger\Client\Model\IsochroneResponse';
        $request = $this->getIsochroneRequest($point, $time_limit, $distance_limit, $vehicle, $buckets, $reverse_flow, $weighting);
     ...
     */
    protected function getIsochroneRequest($point, $time_limit = '600', $distance_limit = null, $vehicle = null, $buckets = '1', $reverse_flow = 'false', $weighting = 'fastest')
    {
        ...
        // query params
        if ($time_limit !== null) {
            $queryParams['time_limit'] = ObjectSerializer::toQueryValue($time_limit, 'int32');
        }
        // query params
        if ($distance_limit !== null) {
            $queryParams['distance_limit'] = ObjectSerializer::toQueryValue($distance_limit, 'int32');
        }
        // query params
        if ($vehicle !== null) {
        ...
        // query params
        if ($buckets !== null) {
            $queryParams['buckets'] = ObjectSerializer::toQueryValue($buckets, 'int32');
        }
        // query params
        if ($reverse_flow !== null) {
            $queryParams['reverse_flow'] = ObjectSerializer::toQueryValue($reverse_flow, null);
        }
        // query params
        if ($weighting !== null) {
