...
/**
 * ClusterConfigurationClustering Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClusterConfigurationClustering implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClusterConfigurationClustering';
...
'min_quantity' => 'getMinQuantity'    ];
    ...
    {
        $this->container['num_clusters'] = isset($data['num_clusters']) ? $data['num_clusters'] : null;
    ...
    {
        return $this->container['num_clusters'];
    }

    /**
     * Sets num_clusters
     *
     * @param float $num_clusters Specifies the number of clusters
     *
     * @return $this
     */
    public function setNumClusters($num_clusters)
    {
        $this->container['num_clusters'] = $num_clusters;
     ...
     * Sets max_quantity
     *
     * @param float $max_quantity Specifies max. quantity in a cluster
     *
     * @return $this
     */
     ...
     * Sets min_quantity
     *
     * @param float $min_quantity Specifies min. quantity in a cluster
     *
     * @return $this
     */
