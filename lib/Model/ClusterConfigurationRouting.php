...
/**
 * ClusterConfigurationRouting Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClusterConfigurationRouting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ClusterConfigurationRouting';
...
'cost_per_meter' => 'getCostPerMeter'    ];
     ...
     * Sets profile
     *
     * @param string $profile The routing profile for which the travel times and distances should be calculated. Other profiles are listed [here](#section/Map-Data-and-Routing-Profiles/OpenStreetMap)
     *
     * @return $this
     */
     ...
     *
     * @param double $cost_per_second Cost per second (travel time)
     *
     * @return $this
     */
     ...
     * Sets cost_per_meter
     *
     * @param double $cost_per_meter Cost per meter (travel distance)
     *
     * @return $this
     */
